(function () {
  ...
  const policyOptions = {
    pph: [['unconfirmed', 'Belum dikonfirmasi'], ['gross', 'Gross — dipotong dari THP'], ['net', 'Net — ditanggung perusahaan, di luar bruto'], ['gross_up', 'Gross-up — tunjangan masuk bruto']],
